...
<br>
	...
	<font size="5" face="Berlin Sans FB">PHYSICS SOLUTIONS</font>
	<div class="hline"></div>
<?php
$query = "SELECT user_id, user_solution, user_date FROM contest_physics ORDER BY user_date";
...
$counter = 1;
	if (mysql_num_rows($query_run) == 0){
		...
		echo '</table>';
		echo "</form>";
		echo "<form action='physics_contest_solutions.php' method='post' name='form'>
