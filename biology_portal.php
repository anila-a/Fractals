...
<title>Fractals - Biology Portal</title>
...
<br>
	...
	<div class="hline"></div>
	<font size="3">
                        <?php  //prepares the table with data from contests_biology.xml
                        $xml = simplexml_load_file('xml/contests_biology.xml');
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from archive_biology.xml
                        $xml = simplexml_load_file('xml/archive_biology.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from video_biology.xml
                        $xml = simplexml_load_file('xml/video_biology.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
