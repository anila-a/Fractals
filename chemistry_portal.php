...
<title>Fractals - Chemistry Portal</title>
...
<br>
	...
	<div class="hline"></div>
	<font size="3">
                        <?php  //prepares the table with data from contests_chemistry.xml
                        $xml = simplexml_load_file('xml/contests_chemistry.xml');
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from archive_chemistry.xml
                        $xml = simplexml_load_file('xml/archive_chemistry.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from video_chemistry.xml
                        $xml = simplexml_load_file('xml/video_chemistry.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
