...
<title>Fractals - Physics Portal</title>
...
<br>
	...
	<div class="hline"></div>
	<font size="3">
                        <?php  //prepares the table with data from contests_physics.xml
                        $xml = simplexml_load_file('xml/contests_physics.xml');
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from archive_physics.xml
                        $xml = simplexml_load_file('xml/archive_physics.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from video_physics.xml
                        $xml = simplexml_load_file('xml/video_physics.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
