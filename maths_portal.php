...
<title>Fractals - Maths Portal</title>
...
<br>
	...
	<div class="hline"></div>
                <font size="3">
                        <?php  //prepares the table with data from contests_maths.xml
                        $xml = simplexml_load_file('xml/contests_maths.xml');
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from archive_maths.xml
                        $xml = simplexml_load_file('xml/archive_maths.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
...
<br>
	...
	<div class="hline"></div>
		<font size="3">
                        <?php  //prepares the table with data from video_maths.xml
                        $xml = simplexml_load_file('xml/video_maths.xml');
                        echo '<table width="600" border="0" cellspacing="5" cellpadding="5">';
